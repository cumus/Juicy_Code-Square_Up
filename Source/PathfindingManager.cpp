...
PathfindingManager::PathfindingManager() : j1Module(), map(NULL), last_path(DEFAULT_PATH_LENGTH), width(0), height(0)
{
	name.create("pathfinding");
}

// Destructor
PathfindingManager::~j1PathFinding()
{
	RELEASE_ARRAY(map);
}
...
void PathfindingManager::SetMap(uint width, uint height, uchar* data)
{
	this->width = width;
	this->height = height;
...
uchar PathfindingManager::GetTileAt(const iPoint& pos) const
{
