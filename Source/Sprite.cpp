...
AnimatedSprite::AnimatedSprite(Behaviour* unit) : Sprite(unit->GetGameobject(), ANIM_SPRITE)
{
	...
	case UNIT_RANGED:
		...
		animations[ATTACKING_N].Setup({ 0, 3285, 464, 365 }, 7, 8.0f);
		animations[ATTACKING_S].Setup({ 0, 3650, 464, 365 }, 7, 8.0f);
		animations[ATTACKING_E].Setup({ 0, 4015, 464, 365 }, 7, 8.0f);
		animations[ATTACKING_W].Setup({ 0, 4380, 464, 365 }, 7, 8.0f);
		animations[ATTACKING_NE].Setup({ 0, 4745, 464, 365 }, 7, 8.0f);
		animations[ATTACKING_NW].Setup({ 0, 5110, 464, 365 }, 7, 8.0f);
